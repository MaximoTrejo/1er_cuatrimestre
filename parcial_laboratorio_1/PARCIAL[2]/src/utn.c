...
int myGetsInt(char *cadena,int longitud){
	...
	if(cadena != NULL && longitud > 0){
		fflush(stdin);
		//fgets lee todo el array y ve si cada cada lugar esta vacio       //sizeof (tamaño) //stdin serian los bits(como un len en )
		if(fgets(bufferString,sizeof(bufferString),stdin) != NULL){

			//srtlen Calcula la longitud de la cadena str hasta el carácter nulo de terminación, pero sin incluirlo.
